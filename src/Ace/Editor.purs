...
foreign import getKeyboardHandler :: forall eff. Editor -> Eff (ace :: ACE | eff) String
...
foreign import getSession :: forall eff. Editor -> Eff (ace :: ACE | eff) EditSession
...
foreign import getValue :: forall eff. Editor -> Eff (ace :: ACE | eff) String

foreign import getSelection :: forall eff. Editor -> Eff (ace :: ACE | eff) Selection
...
foreign import unsetStyle :: forall eff. Editor -> Eff (ace :: ACE | eff) Unit
...
foreign import getScrollSpeed :: forall eff. Editor -> Eff (ace :: ACE | eff) Number
...
foreign import getDragDelay :: forall eff. Editor -> Eff (ace :: ACE | eff) Number
...
foreign import getSelectionStyle :: forall eff. Editor -> Eff (ace :: ACE | eff) String
...
foreign import getHighlightActiveLine :: forall eff. Editor -> Eff (ace :: ACE | eff) Unit
...
foreign import getHighlightSelectedWord :: forall eff. Editor -> Eff (ace :: ACE | eff) Boolean
...
foreign import getShowInvisibles :: forall eff. Editor -> Eff (ace :: ACE | eff) Boolean
...
foreign import getShowPrintMargin :: forall eff. Editor -> Eff (ace :: ACE | eff) Boolean
...
foreign import getPrintMarginColumn :: forall eff. Editor -> Eff (ace :: ACE | eff) Int
...
foreign import getBehavioursEnabled :: forall eff. Editor -> Eff (ace :: ACE | eff) Boolean
...
foreign import getWrapBehavioursEnabled :: forall eff. Editor -> Eff (ace :: ACE | eff) Unit
...
foreign import getShowFoldWidgets :: forall eff. Editor -> Eff (ace :: ACE | eff) Unit
...
foreign import toggleCommentLines :: forall eff. Editor -> Eff (ace :: ACE | eff) Unit
...
foreign import getCursorPosition :: forall eff. Editor -> Eff (ace :: ACE | eff) Position

foreign import getCursorPositionScreen :: forall eff. Editor -> Eff (ace :: ACE | eff) Int
...
foreign import getLastSearchOptions :: forall eff. Editor -> Eff (ace :: ACE | eff) SearchOptions
