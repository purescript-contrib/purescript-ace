...
foreign import onUpdateImpl
  ...
  \    });\
  \  };\
  \}" :: forall eff a. Fn2 BackgroundTokenizer (BackgroundTokenizerEvent -> Eff (ace :: ACE | eff) a) (Eff (ace :: ACE | eff) Unit)
...
foreign import setTokenizerImpl
  ...
  \  };\
  \}" :: forall eff. Fn2 Tokenizer BackgroundTokenizer (Eff (ace :: ACE | eff) Unit)
...
foreign import setDocumentImpl
  ...
  \  };\
  \}" :: forall eff. Fn2 Document BackgroundTokenizer (Eff (ace :: ACE | eff) Unit)
...
foreign import fireUpdateEventImpl
  ...
  \  };\
  \}" :: forall eff. Fn3 Number Number BackgroundTokenizer (Eff (ace :: ACE | eff) Unit)
...
foreign import startImpl
  ...
  \  };\
  \}" :: forall eff. Fn2 Number BackgroundTokenizer (Eff (ace :: ACE | eff) Unit)
...
foreign import stopImpl
  ...
  \    return self.stop();\
  \  };\
  \}" :: forall eff. Fn1 BackgroundTokenizer (Eff (ace :: ACE | eff) Unit)
...
foreign import getTokensImpl
  ...
  \  };\
  \}" :: forall eff. Fn2 Number BackgroundTokenizer (Eff (ace :: ACE | eff) [TokenInfo])
...
foreign import getStateImpl
  ...
  \  };\
  \}" :: forall eff. Fn2 Number BackgroundTokenizer (Eff (ace :: ACE | eff) String)
...
foreign import createImpl
  ...
  \  };\
  \}" :: forall eff. Fn2 Tokenizer Editor (Eff (ace :: ACE | eff) BackgroundTokenizer)
